...
@export var pass_preview_cone_half_angle_degrees: float = 28.0
@export var pass_preview_min_vector_length: float = 64.0
@export var shot_tap_max_duration_seconds: float = 0.18
@export var shot_tap_max_movement_pixels: float = 20.0
...
@export var enable_mobile_haptics: bool = true
