...
@export var made_shot_descent_duration: float = 0.28
@export var made_shot_floor_drop_duration: float = 0.46
@export var made_shot_floor_settle_hop_height: float = 12.0
@export var made_shot_floor_settle_duration: float = 0.12
...
@export var dunk_make_descent_duration: float = 0.24
