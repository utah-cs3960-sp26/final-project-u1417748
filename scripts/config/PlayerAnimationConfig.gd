...
@export var dunk_contact_hold_seconds: float = 0.18
...
@export var dunk_contact_anchor_offset_row_13_east: Vector2 = Vector2(-20.0, 172.0)
@export var dunk_contact_anchor_offset_row_13_west: Vector2 = Vector2(20.0, 172.0)
@export var dunk_contact_anchor_offset_row_15_east: Vector2 = Vector2(-30.0, 162.0)
@export var dunk_contact_anchor_offset_row_15_west: Vector2 = Vector2(30.0, 162.0)
@export var dunk_contact_anchor_offset_row_16_east: Vector2 = Vector2(-42.0, 160.0)
@export var dunk_contact_anchor_offset_row_16_west: Vector2 = Vector2(42.0, 160.0)
@export var dunk_landing_anchor_offset_row_13_east: Vector2 = Vector2(-20.0, 268.0)
@export var dunk_landing_anchor_offset_row_13_west: Vector2 = Vector2(20.0, 268.0)
@export var dunk_landing_anchor_offset_row_15_east: Vector2 = Vector2(-30.0, 258.0)
@export var dunk_landing_anchor_offset_row_15_west: Vector2 = Vector2(30.0, 258.0)
@export var dunk_landing_anchor_offset_row_16_east: Vector2 = Vector2(-42.0, 256.0)
@export var dunk_landing_anchor_offset_row_16_west: Vector2 = Vector2(42.0, 256.0)
...
func get_dunk_contact_anchor_offset(row_index: int, mirror_west: bool = false) -> Vector2:
	match row_index:
		13:
			return dunk_contact_anchor_offset_row_13_west if mirror_west else dunk_contact_anchor_offset_row_13_east
		15:
			return dunk_contact_anchor_offset_row_15_west if mirror_west else dunk_contact_anchor_offset_row_15_east
		16:
			return dunk_contact_anchor_offset_row_16_west if mirror_west else dunk_contact_anchor_offset_row_16_east
	return Vector2.ZERO


func get_dunk_landing_anchor_offset(row_index: int, mirror_west: bool = false) -> Vector2:
	match row_index:
		13:
			return dunk_landing_anchor_offset_row_13_west if mirror_west else dunk_landing_anchor_offset_row_13_east
		15:
			return dunk_landing_anchor_offset_row_15_west if mirror_west else dunk_landing_anchor_offset_row_15_east
		16:
			return dunk_landing_anchor_offset_row_16_west if mirror_west else dunk_landing_anchor_offset_row_16_east
	return Vector2.ZERO
